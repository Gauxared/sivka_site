  ...
  return (
    <section className="page-section detail-page mockup-page service-detail-redesign">
      ...
      <div className="service-detail-top">
        <div>
          <div className="service-detail-photo" style={getPhotoMediaStyle(service.image, service.imagePosition, service.imageScale)} aria-label={service.title} />
          <div className="service-detail-thumbs">
            {[0, 1, 2, 3, 4].map((item) => (
              <span key={item} style={getPhotoMediaStyle(service.image, service.imagePosition, service.imageScale)} />
            ))}
          </div>
        </div>
      ...
      <div className="service-benefit-row">
        ...
        <article><MapPin size={28} /><strong>Удобное расположение</strong><span>Шерегеш и природная территория</span></article>
      </div>
